/* isortid.f -- translated by f2c (version 20200916).
...
/* deck isort */
/* Subroutine */ int isortid_(integer *ix, doublereal *dy, integer *n, 
	integer *kflag)
{
...
/*    changed on 01.02.2001: auxiliary array is now real*8 */
...
/*   array DY.  The array IX may be sorted in increasing order or */
/*   decreasing order.  A slightly modified quicksort algorithm is used. */

/*   Description of Parameters */
/*      IX - integer array of values to be sorted */
/*      DY - real*8 array to be (optionally) carried along */
/*      N  - number of values in integer array IX to be sorted */
/*      KFLAG - control parameter */
/*            =  2  means sort IX in increasing order and carry DY along. */
/*            =  1  means sort IX in increasing order (ignoring DY) */
/*            = -1  means sort IX in decreasing order (ignoring DY) */
/*            = -2  means sort IX in decreasing order and carry DY along. */
...
/*   901012  Declared all variables; changed X,Y to IX,DY. (M. McClain) */
