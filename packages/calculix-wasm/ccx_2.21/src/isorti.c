/* isorti.f -- translated by f2c (version 20200916).
...
/* deck isort */
/* Subroutine */ int isorti_(integer *ix, integer *n, integer *kflag)
{
    ...
    integer i__, j, k, l, m;
    real r__;
    integer t, ij, il[31], kk, nn, iu[31], tt, ty, tty;
