/* calcvol.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int calcvol_(integer *n1, integer *n2, integer *n3, integer *
	n4, doublereal *cotet, doublereal *volume)
{
    doublereal s[3];
...
/*     n1, n2, n3 and n4 */
    ...
    *volume = ((cotet[*n4 * 3 + 1] - cotet[*n1 * 3 + 1]) * s[0] + (cotet[*n4 *
	     3 + 2] - cotet[*n1 * 3 + 2]) * s[1] + (cotet[*n4 * 3 + 3] - 
	    cotet[*n1 * 3 + 3]) * s[2]) / 6.;
