/* isortiii.f -- translated by f2c (version 20200916).
...
/* deck isort */
/* Subroutine */ int isortiii_(integer *ix, integer *iy, integer *iz, integer 
	*n, integer *kflag)
{
    ...
    integer i__, j, k, l, m;
    real r__;
    integer t, ij, il[31], kk, nn, iu[31], tt, ty, uy, tty, uuy;


/*     modified to make the same interchanges in an integer (iy) */
/*     and integer (iz) array! */
...
/*   100411  changed the dimension of IL and IU from 21 to 31 (G. Dhondt) */
...
/*     210401  modified isortiid into isortiii (G. Dhondt) */
