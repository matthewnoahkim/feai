/* edg.f -- translated by f2c (version 20200916).
...
integer edg_(integer *l, integer *k, integer *e)
{
...
/* L10: */
    ...
    ci__1.cierr = 0;
    ci__1.ciunit = 6;
    ci__1.cifmt = "(\"0***error in function edg***\")";
    s_wsfe(&ci__1);
    e_wsfe();
    ci__1.cierr = 0;
    ci__1.ciunit = 6;
    ci__1.cifmt = "(\"***elements not adjacent***\")";
    s_wsfe(&ci__1);
    e_wsfe();
    exit_(&c__201);
    return ret_val;
