/* hybsvd.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int hybsvd_(integer *na, integer *nu, integer *nv, integer *
	nz, integer *nb, integer *m, integer *n, doublereal *a, doublereal *w,
	 logical *matu, doublereal *u, logical *matv, doublereal *v, 
	doublereal *z__, doublereal *b, integer *irhs, integer *ierr, 
	doublereal *rv1)
{
    ...
    /* Local variables */
    integer i__, j;
    extern /* Subroutine */ int mgnsvd_(integer *, integer *, integer *, 
...
/*                                                                       MGN   10 */
/* Subroutine */ int mgnsvd_(integer *nu, integer *nv, integer *nz, integer *
	nb, integer *m, integer *n, doublereal *w, logical *matu, doublereal *
	u, logical *matv, doublereal *v, doublereal *z__, doublereal *b, 
	integer *irhs, integer *ierr, doublereal *rv1)
{
    /* System generated locals */
    ...
    doublereal r__, s;
    real t;
    integer id, im1, ip1, nm1, krhs, iback;
    doublereal scale;
    extern /* Subroutine */ int dswap_(integer *, doublereal *, integer *, 
	    doublereal *, integer *), grsvd_(integer *, integer *, integer *, 
...
/*     DETERMINE CROSS-OVER POINT */
    ...
    if (*matu && *matv) {
	xovrpt = (c__ + 2.3333333333333335) / c__;
    }
    if (*matu && ! (*matv)) {
	xovrpt = (c__ + 2.3333333333333335) / c__;
    }
    if (! (*matu) && *matv) {
	xovrpt = 1.6666666666666667;
    }
    if (! (*matu) && ! (*matv)) {
	xovrpt = 1.6666666666666667;
    }
...
/* L20: */
	...
	for (k = i__; k <= i__2; ++k) {
	    ...
	    s += u[k + i__ * u_dim1] * u[k + i__ * u_dim1];
/* L30: */
	}
...
/* ...    SWAP SINGULAR VALUES AND VECTORS */
	...
	w[id] = t;
	if (*matv) {
	    dswap_(n, &v[i__ * v_dim1 + 1], &c__1, &v[id * v_dim1 + 1], &c__1)
		    ;
	}
	if (*matu) {
	    dswap_(m, &u[i__ * u_dim1 + 1], &c__1, &u[id * u_dim1 + 1], &c__1)
		    ;
	}
	if (*irhs < 1) {
	    goto L360;
...
/* Subroutine */ int grsvd_(integer *nu, integer *nv, integer *nb, integer *m,
	 integer *n, doublereal *w, logical *matu, doublereal *u, logical *
	matv, doublereal *v, doublereal *b, integer *irhs, integer *ierr, 
	doublereal *rv1)
{
    /* System generated locals */
    ...
    doublereal eps;
    integer its;
    doublereal scale, dummy;
    extern doublereal srelpr_(doublereal *);
...
L480:
	...
	for (ll = 1; ll <= i__2; ++ll) {
	    l1 = k - ll;
	    l = l1 + 1;
	    if ((d__1 = rv1[l], abs(d__1)) <= eps) {
		goto L550;
	    }
/*     ********** RV1(1) IS ALWAYS ZERO, SO THERE IS NO EXIT */
/*                THROUGH THE BOTTOM OF THE LOOP ********** */
	    if ((d__1 = w[l1], abs(d__1)) <= eps) {
		goto L500;
	    }
/* L490: */
	}
...
/*     ********** SHIFT FROM BOTTOM 2 BY 2 MINOR ********** */
	...
	g = sqrt(f * f + 1.f);
	f = ((x - z__) * (x + z__) + h__ * (y / (f + d_sign(&g, &f)) - h__)) /
		 x;
...
/*      RETURN */
/*      END */
doublereal srelpr_(doublereal *dummy)
{
    /* System generated locals */
    doublereal ret_val;
