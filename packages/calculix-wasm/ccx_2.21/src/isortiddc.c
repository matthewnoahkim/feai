/* isortiddc.f -- translated by f2c (version 20200916).
...
/* deck isort */
/* Subroutine */ int isortiddc_(integer *ix, doublereal *dy1, doublereal *dy2,
	 char *cy, integer *n, integer *kflag, ftnlen cy_len)
{
    ...
    char uy[20];
    doublereal tx2, ty11, ty12, ty21, ty22;
    char uuy[20];
    doublereal ttx2, tty11, tty12, tty21, tty22;
    integer iside, istat;
...
L100001:
	...
	ix[(i__ << 1) + 1] = ix[(i__ << 1) + 1] * 10 + iside;
    }
...
L100002:
	...
	ix[(i__ << 1) + 1] = (ix[(i__ << 1) + 1] - iside) / 10;
    }
