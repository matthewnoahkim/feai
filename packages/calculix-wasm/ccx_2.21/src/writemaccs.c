/* writemaccs.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int writemaccs_(doublereal *mac, integer *nev, integer *nm)
{
    /* Format strings */
...
/*      mac contains the MAC-Values */
    ...
    e_wsle();
    s_wsle(&io___2);
    do_lio(&c__9, &c__1, "    Modal Assurance Criterium", (ftnlen)29);
    e_wsle();
    s_wsle(&io___3);
    do_lio(&c__9, &c__1, "       Nodal Diameter", (ftnlen)21);
    do_lio(&c__3, &c__1, (char *)&nm[1], (ftnlen)sizeof(integer));
    e_wsle();
