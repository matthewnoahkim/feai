/* uhardening.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int uhardening_(char *amat, integer *iel, integer *iint, 
	doublereal *t1l, doublereal *epini, doublereal *ep, doublereal *dtime,
	 doublereal *fiso, doublereal *dfiso, doublereal *fkin, doublereal *
	dfkin, ftnlen amat_len)
{
