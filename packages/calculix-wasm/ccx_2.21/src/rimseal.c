/* rimseal.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int rimseal_(integer *node1, integer *node2, integer *nodem, 
	...
	iaxial, doublereal *co, doublereal *vold, integer *iplausi, ftnlen 
	lakon_len, ftnlen set_len)
{
    ...
    /* Local variables */
    doublereal p1, pi;
    extern /* Subroutine */ int rimseal_calc__(doublereal *);
