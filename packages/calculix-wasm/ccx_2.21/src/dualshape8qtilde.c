/* dualshape8qtilde.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int dualshape8qtilde_(doublereal *xi, doublereal *et, 
...
/*     transformed standard shape functions */
    ...
    shp[10] = shpold[3] * 1.f + alpha * shpold[31] + alpha * shpold[52];
    shp[17] = shpold[10] * 1.f + alpha * shpold[31] + alpha * shpold[38];
    shp[24] = shpold[17] * 1.f + alpha * shpold[38] + alpha * shpold[45];
    shp[31] = shpold[24] * 1.f + alpha * shpold[45] + alpha * shpold[52];
    shp[38] = (1.f - alpha * 2.f) * shpold[31];
    shp[45] = (1.f - alpha * 2.f) * shpold[38];
    shp[52] = (1.f - alpha * 2.f) * shpold[45];
    shp[59] = (1.f - alpha * 2.f) * shpold[52];
