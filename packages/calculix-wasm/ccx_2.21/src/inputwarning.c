/* inputwarning.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int inputwarning_(char *inpc, integer *ipoinpc, integer *
	iline, char *text, ftnlen inpc_len, ftnlen text_len)
{
