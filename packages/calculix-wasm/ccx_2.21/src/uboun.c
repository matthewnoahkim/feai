/* uboun.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int uboun_(doublereal *boun, integer *kstep, integer *kinc, 
...
/*        boun=100. */
/*      endif */
/*      if((time(1).gt.5.e-9).and.(ipkon(33).gt.0)) ipkon(33)=-2-ipkon(33) */
