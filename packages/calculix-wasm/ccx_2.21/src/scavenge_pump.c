/* scavenge_pump.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int scavenge_pump__(integer *node1, integer *node2, integer *
	...
	char *set, integer *ntmat___, integer *mi, doublereal *ttime, 
	doublereal *time, integer *iaxial, integer *iplausi, ftnlen lakon_len,
	 ftnlen set_len)
{
