/* straighteq3d.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int straighteq3d_(doublereal *col, doublereal *straight)
{
    /* Builtin functions */
...
/*     p12 x xn */
    ...
    straight[9] = p12[1] * straight[15] - p12[2] * straight[14];
    straight[10] = p12[2] * straight[13] - p12[0] * straight[15];
    straight[11] = p12[0] * straight[14] - p12[1] * straight[13];
...
/*     p23 x xn */
    ...
    straight[1] = p23[1] * straight[15] - p23[2] * straight[14];
    straight[2] = p23[2] * straight[13] - p23[0] * straight[15];
    straight[3] = p23[0] * straight[14] - p23[1] * straight[13];
...
/*     p31 x xn */
    ...
    straight[5] = p31[1] * straight[15] - p31[2] * straight[14];
    straight[6] = p31[2] * straight[13] - p31[0] * straight[15];
    straight[7] = p31[0] * straight[14] - p31[1] * straight[13];
