/* getnumberofnodes.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int getnumberofnodes_(integer *nelem, integer *jface, char *
	lakon, integer *nope, integer *nopes, integer *mint2d, ftnlen 
	lakon_len)
{
    /* Builtin functions */
