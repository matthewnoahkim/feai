/* shape8qtilde_lin.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int shape8qtilde_lin__(doublereal *xi, doublereal *et, 
...
/*     shape functions */
    ...
    shp[25] = (*xi + 1.) * (*et + 1.) / 4.;
    shp[32] = (1. - *xi) * (*et + 1.) / 4.;
    shp[39] = (1. - *xi * *xi) * (1. - *et) / 2.;
    shp[46] = (*xi + 1.) * (1. - *et * *et) / 2.;
    shp[53] = (1. - *xi * *xi) * (*et + 1.) / 2.;
    shp[60] = (1. - *xi) * (1. - *et * *et) / 2.;
