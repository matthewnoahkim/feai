/* drfftf.f -- translated by f2c (version 20200916).
	...
	doublereal *wa4)
{
    ...
    /* Local variables */
    integer i__, k, ic;
    doublereal ci2, di2, ci4, ci5, di3, di4, di5, ci3, cr2, cr3, dr2, dr3, 
...
/* Subroutine */ int drfftf_(integer *n, doublereal *r__, doublereal *wsave, 
	integer *isave)
{
    extern /* Subroutine */ int drfftf1_(integer *, doublereal *, doublereal *
	    , doublereal *, integer *);
    ...
    drfftf1_(n, &r__[1], &wsave[1], &wsave[*n + 1], &isave[1]);
    return 0;
} /* drfftf_ */

/* Subroutine */ int drfftf1_(integer *n, doublereal *c__, doublereal *ch, 
...
/* Subroutine */ int drffti_(integer *n, doublereal *wsave, integer *isave)
{
    extern /* Subroutine */ int drffti1_(integer *, doublereal *, integer *);
    ...
    drffti1_(n, &wsave[*n + 1], &isave[1]);
    return 0;
} /* drffti_ */

/* Subroutine */ int drffti1_(integer *n, doublereal *wa, integer *ifac)
{
    /* Initialized data */
