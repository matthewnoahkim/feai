/* umat_lin_iso_el.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int umat_lin_iso_el__(char *amat, integer *iel, integer *
	iint, integer *kode, doublereal *elconloc, doublereal *emec, 
	doublereal *emec0, doublereal *beta, doublereal *xokl, doublereal *
	voj, doublereal *xkl, doublereal *vj, integer *ithermal, doublereal *
	t1l, doublereal *dtime, doublereal *time, doublereal *ttime, integer *
	icmd, integer *ielas, integer *mi, integer *nstate___, doublereal *
	xstateini, doublereal *xstate, doublereal *stre, doublereal *stiff, 
	integer *iorien, doublereal *pgauss, doublereal *orab, ftnlen 
	amat_len)
{
