/* shape6tritilde.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int shape6tritilde_(doublereal *xi, doublereal *et, 
...
/*     shape functions */
    ...
    shp[11] = shpold[3] * 1.f + alpha * shpold[24] + alpha * shpold[38];
    shp[18] = shpold[10] * 1.f + alpha * shpold[24] + alpha * shpold[31];
    shp[25] = shpold[17] * 1.f + alpha * shpold[31] + alpha * shpold[38];
    shp[32] = (1.f - alpha * 2.f) * shpold[24];
...
/*     local 2nd order derivatives of the shape functions: xi,xi-derivative */
	...
	shp[12] = shpold[4] * 1.f + alpha * shpold[25] + alpha * shpold[39];
	shp[19] = shpold[11] * 1.f + alpha * shpold[25] + alpha * shpold[32];
	shp[26] = shpold[18] * 1.f + alpha * shpold[32] + alpha * shpold[39];
	shp[33] = (1.f - alpha * 2.f) * shpold[25];
...
/*     local 2nd order derivatives of the shape functions: xi,eta-derivative */
	...
	shp[13] = shpold[5] * 1.f + alpha * shpold[26] + alpha * shpold[40];
	shp[20] = shpold[12] * 1.f + alpha * shpold[26] + alpha * shpold[33];
	shp[27] = shpold[19] * 1.f + alpha * shpold[33] + alpha * shpold[40];
	shp[34] = (1.f - alpha * 2.f) * shpold[26];
...
/*     local 2nd order derivatives of the shape functions: eta,eta-derivative */
	...
	shp[14] = shpold[6] * 1.f + alpha * shpold[27] + alpha * shpold[41];
	shp[21] = shpold[13] * 1.f + alpha * shpold[27] + alpha * shpold[34];
	shp[28] = shpold[20] * 1.f + alpha * shpold[34] + alpha * shpold[41];
	shp[35] = (1.f - alpha * 2.f) * shpold[27];
