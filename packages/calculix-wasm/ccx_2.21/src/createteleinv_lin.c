/* createteleinv_lin.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int createteleinv_lin__(integer *ipkon, integer *kon, char *
	lakon, integer *islavsurf, doublereal *contr, integer *icontr1, 
	integer *icontr2, integer *icounter, integer *lface, ftnlen lakon_len)
{
