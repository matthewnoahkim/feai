/* materialdata_dvifem.f -- translated by f2c (version 20200916).
...
/* Subroutine */ int materialdata_dvifem__(integer *imat, integer *ntmat___, 
	doublereal *t1l, doublereal *shcon, integer *nshcon, doublereal *dvi)
{
