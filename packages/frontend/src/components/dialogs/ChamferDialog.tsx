        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-cad-border bg-white">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-cad-accent/20 flex items-center justify-center">
              <Triangle size={14} className="text-cad-accent" />
            </div>
        ...
        <div className="p-4 space-y-4 max-h-[70vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            {availableParts.length === 0 ? (
              ...
              <div className="space-y-2 max-h-36 overflow-y-auto bg-white border border-cad-border p-2">
            ...
            {(chamferType === 'two-distance' || chamferType === 'angle-distance') && (
              <div className="pt-2 border-t border-cad-border">
                <button
                  ...
                  className={`
                    w-full flex items-center justify-center gap-2 py-2 transition-colors text-sm
                    ${flipped 
                      ? 'bg-cad-accent/20 border border-cad-accent/50 text-cad-text' 
                      : 'bg-white border border-cad-border hover:bg-cad-panel text-cad-text-dim'}
                  `}
                >
            ...
            <div className="mt-3 p-3 bg-white">
              <div className="flex items-center justify-center">
                <svg width="120" height="80" viewBox="0 0 120 80">
                  ...
                  {/* Dimension labels */}
                  <text x="60" y="15" fill="#1a4d8f" fontSize="10" textAnchor="middle">
                    {chamferType === 'two-distance' ? (flipped ? `D2: ${distance2}` : `D1: ${distance1}`) : `D: ${distance1}`}
                  </text>
                  <text x="112" y="45" fill="#1a4d8f" fontSize="10" textAnchor="start">
                    {chamferType === 'two-distance' ? (flipped ? `D1: ${distance1}` : `D2: ${distance2}`) : ''}
                  </text>
                  {chamferType === 'angle-distance' && (
                    <text x="75" y="50" fill="#1a4d8f" fontSize="10" textAnchor="middle">
                      {angle}°
                    </text>
                  )}
                </svg>
